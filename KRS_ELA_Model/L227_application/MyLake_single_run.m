clear all;
path(path,'/Users/krsalkgu/Documents/MATLAB/KRS_ELA_Model/v2') %path for MyLake v2
path(path,'/Users/krsalkgu/Documents/MATLAB/KRS_ELA_Model/v12') %path for MyLake v1.2
path(path,'/Users/krsalkgu/Documents/MATLAB/KRS_ELA_Model/air_sea') %path for air-sea toolbox
path(path,'/Users/krsalkgu/Documents/MATLAB/KRS_ELA_Model/Sediments') %path for sediments
path(path,'/Users/krsalkgu/Documents/MATLAB/KRS_ELA_Model/L227_application') %path for model

%KRS added 2017-08-24
lake='Lake 227';
year=1969;
m_start=[1969,6,27]; 
m_stop=[2009,12,31];
...
disp('Saving results...')
save('L227_application/MyLakeResults.mat', 'MyLake_results', 'Sediment_results')
disp('Finished at:')
disp(datetime('now'));
...
%2017-08-25: commented out (KRS). Will be added back in with L227 data
%after model is running
